...
const Card = (props) => {
  ...
  return (
    <button
      ...
      // className="m-1 text-white bg-gradient-to-tr from-blue-600 to-red-900 ring-2 ring-black ring-insets p-0.5 md:p-6 shadow-xl shadow-blue-500/30 invert focus:invert focus:scale-100 shadow-blue-500/100 scale-110 duration-500"
    >
      <div className="flex justify-center items-center">{props.logo}</div>
      {/* <img className="invert" src={process.env.PUBLIC_URL + "/images/JeraldPicNoBG.png"} alt="" /> */}
